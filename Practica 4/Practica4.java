...
public static void main(String args[]){
    ...
    for (int j = 0; j < 26; j++){
        ...
        Arrays.sort(abc);
        letra[] top10 = new letra[10];
        System.arraycopy(abc, 0, top10, 0, 10);

        for(int k = 0; k < 10; k++){
            System.out.print("\n" + abc[k].letras +": " + abc[k].counter + "   ");
            for (int h = 0; h < top10[k].counter; h++){
                System.out.print("*");
            }
        }
